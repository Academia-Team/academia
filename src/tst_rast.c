...
void tst_plot_rast32(UINT32 *base, BOOL destruct, BOOL blackScreen)
{
	...
	the image cropped.*/
	blackScreen ? fill_scrn(base) : clr_scrn(base);
	plot_rast32(base, 0, RAST32H_MAX_VIS_Y, height, tstBmp, destruct,
		blackScreen);
	Cconin();
	...
	blackScreen ? fill_scrn(base) : clr_scrn(base);
	plot_rast32(base, RAST32_MAX_VIS_X, RAST32H_MAX_VIS_Y, height, tstBmp,
	...
	blackScreen ? fill_scrn(base) : clr_scrn(base);
	plot_rast32(base, 0, RAST32H_MID_VIS_Y, height, tstBmp, destruct,
		blackScreen);
	Cconin();
	...
	blackScreen ? fill_scrn(base) : clr_scrn(base);
	plot_rast32(base, SCRN_MID_X, RAST32H_MID_VIS_Y, height, tstBmp,
		destruct, blackScreen);
	Cconin();
	...
	blackScreen ? fill_scrn(base) : clr_scrn(base);
	plot_rast32(base, RAST32_LHALF_X, 0, height, tstBmp, destruct, blackScreen);
	Cconin();
	...
	is cropped off.*/
	blackScreen ? fill_scrn(base) : clr_scrn(base);
	plot_rast32(base, 0, RAST32H_THALF_Y, height, tstBmp, destruct, blackScreen);
	Cconin();

	/*TEST 16: When y is set to a value such that only the bottommost row 
	constituting the image is on screen.*/
	blackScreen ? fill_scrn(base) : clr_scrn(base);
	plot_rast32(base, 0, RAST32H_MIN_Y, height, tstBmp, destruct, blackScreen);
	Cconin();
	...
	blackScreen ? fill_scrn(base) : clr_scrn(base);
	plot_rast32(base, RAST32_RHALF_X, 0, height, tstBmp, destruct,
		blackScreen);
	Cconin();
	...
	1px from the bottom.*/
	blackScreen ? fill_scrn(base) : clr_scrn(base);
	plot_rast32(base, 0, RAST32H_MAX_VIS_Y + 1, height, tstBmp, destruct,
		blackScreen);
	Cconin();
	...
	blackScreen ? fill_scrn(base) : clr_scrn(base);
	plot_rast32(base, 0, RAST32H_BHALF_Y, height, tstBmp, destruct,
		blackScreen);
	Cconin();
...
void tst_plot_rast16(UINT16 *base, BOOL destruct, BOOL blackScreen)
{
	...
	the image cropped.*/
	blackScreen ? fill_scrn(base_32) : clr_scrn(base_32);
	plot_rast16(base, 0, RAST16H_MAX_VIS_Y, height, tstBmp, destruct,
		blackScreen);
	Cconin();
	...
	without getting the image cropped.*/
	blackScreen ? fill_scrn(base_32) : clr_scrn(base_32);
	plot_rast16(base, RAST16_MAX_VIS_X, RAST16H_MAX_VIS_Y, height, tstBmp,
		destruct, blackScreen);
	Cconin();
	...
	is contained in the vertical center of the screen.*/
	blackScreen ? fill_scrn(base_32) : clr_scrn(base_32);
	plot_rast16(base, 0, RAST16H_MID_VIS_Y, height, tstBmp, destruct,
		blackScreen);
	Cconin();
	...
	image is in the center of the screen.*/
	blackScreen ? fill_scrn(base_32) : clr_scrn(base_32);
	plot_rast16(base, RAST16_MID_VIS_X, RAST16H_MID_VIS_Y, height,
	...
	cropped from the left.*/
	blackScreen ? fill_scrn(base_32) : clr_scrn(base_32);
	plot_rast16(base, RAST16_LHALF_X, 0, height, tstBmp, destruct, blackScreen);
	Cconin();
	...
	is cropped off.*/
	blackScreen ? fill_scrn(base_32) : clr_scrn(base_32);
	plot_rast16(base, 0, RAST16H_THALF_Y, height, tstBmp, destruct, blackScreen);
	Cconin();

	/*TEST 16: When y is set to a value such that only the bottommost row 
	constituting the image is on screen.*/
	blackScreen ? fill_scrn(base_32) : clr_scrn(base_32);
	plot_rast16(base, 0, RAST16H_MIN_Y, height, tstBmp, destruct, blackScreen);
	Cconin();
	...
	cropped from the right.*/
	blackScreen ? fill_scrn(base_32) : clr_scrn(base_32);
	plot_rast16(base, RAST16_RHALF_X, 0, height, tstBmp, destruct,
		blackScreen);
	Cconin();
	...
	1px from the bottom.*/
	blackScreen ? fill_scrn(base_32) : clr_scrn(base_32);
	plot_rast16(base, 0, RAST16H_MAX_VIS_Y + 1, height, tstBmp, destruct,
		blackScreen);
	Cconin();
	...
	image is cropped off.*/
	blackScreen ? fill_scrn(base_32) : clr_scrn(base_32);
	plot_rast16(base, 0, RAST16H_BHALF_Y, height, tstBmp, destruct,
		blackScreen);
	Cconin();
